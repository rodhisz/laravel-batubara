										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">Rp {{number_format($row->grand_total)}}</div>
                                                    </td>
                                                </tr>
                                                @endforeach
										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">Rp {{number_format($row->gr_grand_total)}}</div>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                <tr class="grand-total">
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">Rp {{number_format($gr_totalgrandtotal)}}</div>
                                                    </td>
                                                </tr>
											</tbody>
										</table>
										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">Rp {{number_format($row->gi_grand_total)}}</div>
                                                    </td>
                                                </tr>
                                                @endforeach
												<tr class="grand-total">
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">Rp {{number_format($gi_totalgrandtotal)}}</div>
                                                    </td>
                                                </tr>
											</tbody>
										</table>
										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-3">Rp {{number_format($row->ito_all_soh)}}</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr>
                                                    ...
                                                    @foreach ($data_ito_all->slice(0,1) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-3">Rp {{number_format($row->ito_all_usage)}}</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr>
                                                    ...
                                                    @foreach ($data_ito_all->slice(0,1) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">{{$row->ito_all_plan}} <p>Hari</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr>
                                                    ...
                                                    @foreach ($data_ito_all->slice(0,1) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">{{$row->ito_all_aktual}} <p>Hari</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr class="grand-total">
                                                    ...
                                                    @foreach ($data_ito_all->slice(0,1) as $row)
                                                    <td class="text-center">{{number_format($row->ito_all_achievement*100, 2)}} %</td>
                                                    @endforeach
                                                </tr>
											</tbody>
										</table>
										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-3">Rp {{number_format($row->soh)}}</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												...
												<tr>
                                                    ...
                                                    @foreach ($data_ito->slice(0, 4) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-3">Rp {{number_format($row->usage)}}</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												...
												<tr>
                                                    ...
                                                    @foreach ($data_ito->slice(0, 4) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">{{$row->plan}} <p>Hari</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr>
                                                    ...
                                                    @foreach ($data_ito->slice(0, 4) as $row)
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">{{$row->aktual}} <p>Hari</p></div>
                                                    </td>
                                                    @endforeach
                                                </tr>
												<tr class="grand-total">
                                                    ...
                                                    @foreach ($data_ito->slice(0, 4) as $row)
                                                    <td
                                                        class="text-center">{{number_format($row->achievement*100, 2)}} %
                                                    </td>
                                                    @endforeach
                                                </tr>
											</tbody>
                ...
                <div class="d-flex gap-3 mb-3">
										...
										<table class="table custom-table table-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center"><strong>{{number_format($row->achievement*100, 2)}} %</strong></td>
                                                </tr>
                                                @endforeach
											</tbody>
										</table>
                    ...
                    <div class="card col shadow-sm p-3">
                        <div class="card-body">
                            ...
                            <ul>
                                <li class="mb-2">Untuk project dengan Achievement ITO di atas 100 % diharapkan untuk konsisten dalam menjaga performancenya.</li>
                                <li class="mb-2">Untuk project dengan Achievement ITO di bawah 100% harap segera mengejar ketertinggalan dan fokus terhadap
                                    peningkatan performance.</li>
                                <li class="mb-2">Untuk project yang berada di posisi 3 terbawah harap segera melakukan langkah korektif.</li>
                            </ul>
